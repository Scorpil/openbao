...
source code](https://github.com/openbao/openbao/blob/main/builtin/credential/aws/cli.go).
...
import (
	...
	vault "github.com/openbao/openbao/api"
	auth "github.com/openbao/openbao/api/auth/aws"
)
